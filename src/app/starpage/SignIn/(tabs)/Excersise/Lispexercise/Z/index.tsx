    ...
    <View style={styles.container}>
      ...
      <View style={styles.FirstView}>
        <TouchableOpacity onPress={() => {}}>
         ...
         <Text style={styles.txt}>تمارين حرف الزاي</Text>
      ...
      <TouchableOpacity  style={styles.buttonTwo} onPress={()=>router.push('starpage/SignIn/(tabs)/Excersise/Lispexercise/Z/ExZ')}>
        <Text style={styles.textStylo}>تمارين خاصة بلثغة حرف الزاي </Text>
       
      </TouchableOpacity>


      <TouchableOpacity  style={styles.buttonTwo} onPress={()=>router.push('starpage/SignIn/(tabs)/Excersise/Lispexercise/Z/wordsZ')}>
        <Text style={styles.textStylo}>{"كلمات بحرف الزاي"}</Text>
